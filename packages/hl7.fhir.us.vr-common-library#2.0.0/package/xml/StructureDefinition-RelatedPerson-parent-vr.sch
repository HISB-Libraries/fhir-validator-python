...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <!-- 
    This file contains just the constraints for the profile USCoreRelatedPersonProfile
  ...
  <sch:pattern>
    <sch:title>f:RelatedPerson/f:birthDate/f:extension</sch:title>
    <sch:rule context="f:RelatedPerson/f:birthDate/f:extension">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
