...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Bundle/f:entry/f:request">
      <sch:assert test="count(f:extension[@url = 'http://hl7.org/fhir/us/bser/StructureDefinition/query-description']) &lt;= 1">extension with URL = 'http://hl7.org/fhir/us/bser/StructureDefinition/query-description': maximum cardinality of 'extension' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
</sch:schema>
